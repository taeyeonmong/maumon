...
import { type LightboxProps, type LightboxMedia } from './Lightbox';
type LightboxOptions = Omit<LightboxProps, 'isOpen' | 'onOpenChange' | 'media' | 'index' | 'defaultIndex' | 'onIndexChange'>;
