 ...
 */
export declare function useToggleButtonGroup(): ToggleButtonGroupContextValue | null;
 ...
 * ```
 */
export declare function ToggleButtonGroup(props: ToggleButtonGroupProps): ReactNode;
