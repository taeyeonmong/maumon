 ...
 * ```
 */
export declare function OverflowList({ children, gap, minVisibleItems, collapseFrom, behavior, overflowRenderer, xstyle, className, style, ref, ...props }: OverflowListProps): import("react").JSX.Element;
