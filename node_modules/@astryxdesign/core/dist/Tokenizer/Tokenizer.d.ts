...
export type { InputStatus as TokenizerStatus, InputStatusType as TokenizerStatusType, } from '../Field';
/**
...
export interface TokenizerProps<T extends SearchableItem> extends Omit<BaseProps<HTMLDivElement>, 'onChange'> {
