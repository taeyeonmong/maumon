...
import type { ComponentType, HTMLAttributes, Ref, TdHTMLAttributes, ThHTMLAttributes, ReactNode } from 'react';
 ...
 * @template T - The row data type
 */
export interface BaseTableProps<T extends Record<string, unknown>> extends BaseProps<HTMLTableElement> {
