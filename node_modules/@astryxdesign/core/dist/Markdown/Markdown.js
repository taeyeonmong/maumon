...
function wrapTextWithFade(content, cursor, key) {
  ...
  const nodes = segments.map(seg => seg.fading ? /*#__PURE__*/_jsx("span", {
    ...{
      className: "x1hc1fzr x19991ni x80gvsz xlr8y92 x4itv7f"
    },
    children: seg.text
