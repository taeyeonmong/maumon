 ...
 * ```
 */
export declare function CommandPaletteInput({ value: controlledValue, onValueChange, placeholder, hasAutoFocus, endContent, onChange, onKeyDown, ref, xstyle, ...props }: CommandPaletteInputProps): import("react").JSX.Element;
