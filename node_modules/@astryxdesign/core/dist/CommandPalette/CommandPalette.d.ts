 ...
 * ```
 */
export declare function CommandPalette<T extends SearchableItem = SearchableItem>({ ref, isOpen, isInline, onOpenChange, searchSource, input, footer, renderItem, emptySearchText, emptyBootstrapText, value: controlledValue, onValueChange, label, width, maxHeight, }: CommandPaletteProps<T>): import("react").JSX.Element;
