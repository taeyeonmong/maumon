 ...
 * ```
 */
export declare function Link({ as, label, href, hasUnderline, isDisabled, isExternalLink, newTabLabel, target: targetFromProps, onClick, tooltip, isStandalone, type, size, weight, color, display, maxLines, children, rel: relFromProps, xstyle, className, style, ref, ...props }: LinkProps): import("react").JSX.Element;
