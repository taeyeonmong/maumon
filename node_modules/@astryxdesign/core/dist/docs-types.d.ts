...
interface BaseDoc {
    ...
    category?: 'Action' | 'Chat' | 'Container' | 'Content' | 'Data Input' | 'Data Visualization' | 'Feedback & Status' | 'Layout' | 'Navigation' | 'Overlay' | 'Table & List' | 'Utility';
 ...
 */
export type ComponentDoc = SingleComponentDoc | MultiComponentDoc | SubComponentDoc;
/**
 ...
 */
export type TokenPreviewType = 'swatch' | 'shadow-box' | 'radius-box' | 'spacing-bar' | 'size-bar' | 'border-line' | 'duration-bar' | 'easing-curve' | 'font-sample';
/**
