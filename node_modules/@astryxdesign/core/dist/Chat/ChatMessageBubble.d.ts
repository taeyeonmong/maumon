 ...
 * ```
 */
export declare function ChatMessageBubble({ children, variant, name, metadata, group, xstyle, className, style: styleProp, 'data-testid': testId, ref, }: ChatMessageBubbleProps): import("react").JSX.Element;
