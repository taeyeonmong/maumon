 ...
 * ```
 */
export declare function ResizeHandle({ direction, position: positionMode, isReversed, isDisabled, hasDivider, isAlwaysVisible, pillPlacement, label, resizable, children, xstyle, className, ref, ...props }: ResizeHandleProps): import("react").JSX.Element;
