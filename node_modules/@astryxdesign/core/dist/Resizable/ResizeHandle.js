 ...
 */
function hitAreaBias(effectiveSide) {
...
const dynamicStyles = {
  hitAreaBiasX: pct => [_temp, {
    "--x-transform": `translateX(-${pct})` != null ? `translateX(-${pct})` : undefined
  }],
  hitAreaBiasY: pct => [_temp2, {
    "--x-transform": `translateY(-${pct})` != null ? `translateY(-${pct})` : undefined
  }],
