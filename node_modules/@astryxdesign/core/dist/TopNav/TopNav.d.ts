 ...
 * ```
 */
export declare function TopNav({ heading, startContent, children, centerContent, endContent, label, xstyle, className, style, ref, ...props }: TopNavProps): import("react").JSX.Element | null;
