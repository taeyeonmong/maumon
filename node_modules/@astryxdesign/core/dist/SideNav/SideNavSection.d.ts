 ...
 * ```
 */
export declare function SideNavSection({ ref, title, subtitle, children, endContent, isHeaderHidden, xstyle, className, style, 'data-testid': testId, }: SideNavSectionProps): React.JSX.Element;
