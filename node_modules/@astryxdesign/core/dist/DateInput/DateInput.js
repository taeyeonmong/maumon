...
export function DateInput({
  ...
  const displayValue = pendingInput !== null ? pendingInput : optimisticValue && /^\d{4}-\d{2}-\d{2}$/.test(optimisticValue) ? plainDateFormat(plainDateFromISO(optimisticValue), DATE_FORMAT_LONG) : '';
